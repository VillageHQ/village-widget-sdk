...
function Te({
  ...
  return i.append("paths_cta", u), `https://village.do/widget?${i.toString()}`;
}
function St(t, e) {
...
class At {
  ...
  handleOAuthRequest(e) {
    const { isAuthorizationFlow: n } = e, r = `https://village.do/widget/${n ? "resolve-auth" : "oauth"}`, s = new URLSearchParams();
...
const P = class P {
  ...
  constructor(e, n) {
    this.partnerKey = e, this.userReference = null, this.token = L.get("village.token"), this.config = n, this.url = null, this.module = null, this.iframe = null, this.observer = null, this.inlineSearchIframes = /* @__PURE__ */ new Map(), this.messageHandlers = new At(this), this.moduleHandlers = new or(this), this.apiUrl = "https://api.village.do", this.hasRenderedButton = !1, this.elementRequests = /* @__PURE__ */ new Map(), this.elementRequestIds = /* @__PURE__ */ new Map(), this.globalRequestCounter = 0, this.processedSignatures = /* @__PURE__ */ new Set(), this.initialized = !1;
  }
  async init() {
