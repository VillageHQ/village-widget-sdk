// Deployed: 2025-05-02T20:17:25.941Z
// Version: 1.0.47
(function() {
  "use strict";
  try {
...
`;
  ...
  class App {
    ...
    handleNewElements(mutation) {
      mutation.addedNodes.forEach((node) => {
        ...
        if (this.hasVillageAttributes(node)) {
          this.addListenerToElement(node);
          return;
        }
        const selector = `[${VILLAGE_URL_DATA_ATTRIBUTE}], [${VILLAGE_MODULE_ATTRIBUTE}]`;
        node.querySelectorAll(selector).forEach(this.addListenerToElement.bind(this));
      });
    }
    ...
    getButtonChildren(element) {
      ...
      return { foundElement, notFoundElement, loadingElement };
    }
    initializeButtonState(element) {
      const { foundElement, notFoundElement, loadingElement } = this.getButtonChildren(element);
      if (!this.token) {
...
//# sourceMappingURL=village-widget-dev.js.map
